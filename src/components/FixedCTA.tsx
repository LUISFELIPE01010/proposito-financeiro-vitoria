    ...
    <div className="fixed bottom-0 left-0 right-0 bg-white shadow-2xl border-t border-gray-200 p-4 z-50 animate-slide-up">
      <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="text-center sm:text-left">
          <h3 className="font-heading font-bold text-brand-black text-lg">
        ...
        <div className="flex items-center gap-3">
          <Button 
            ...
            className="bg-brand-gold hover:bg-brand-gold/90 text-white px-6 py-3 font-semibold rounded-full transition-all duration-300 whitespace-nowrap"
          >
            Quero começar agora
          </Button>
